...
SYNONYM_BANK = {
    "drawer": ["compartment", "cabinet drawer", "storage compartment"],
    "equipment": ["apparatus", "device", "gear", "tools", "machinery"],
    "office supplies": ["stationery", "office materials", "office equipment"],
    "potted plant": ["plant pot", "indoor plant"],
    "browse": ["look around", "shop around", "scan"],
    "be responsible for": ["be in charge of", "handle", "oversee"],
    "purchase": ["buy", "acquire", "procure", "obtain"],
    "approval": ["authorization", "permission", "consent"],
    "present": ["introduce", "deliver", "give a presentation"],
    "research": ["study", "investigate", "examine"],
    "marketing team": ["marketing department", "promotion team"],
    "available": ["accessible", "obtainable", "in stock", "vacant"],
    "ship": ["send", "deliver", "dispatch"],
    "branch": ["office", "outlet", "local office"],
    "quality assurance": ["quality control", "inspection", "testing"],
    "product testing": ["trial", "quality test", "inspection"],
    "delivery van": ["delivery vehicle", "courier van"],
    "graphic design": ["visual design", "graphics"],
    "sample": ["specimen", "example", "model"],
    "require": ["need", "demand", "call for"],
    "maintenance": ["upkeep", "repair", "servicing"],
    "paperwork": ["documents", "documentation", "forms"],
    "mobile app": ["application", "software"],
    "recognize": ["identify", "acknowledge"],
    "experiment": ["trial", "test"],
    "speed up": ["accelerate", "expedite", "quicken"],
    "process": ["procedure", "method", "handle"],
    "upgrade": ["improve", "enhance", "modernize"],
    "shuttle bus": ["shuttle", "courtesy bus"],
    "staff website": ["employee portal", "intranet"],
    "symptom": ["sign", "indication"],
    "apply": ["use", "administer", "put on", "submit"],
    "market conditions": ["business climate", "market situation"],
    "assorted": ["various", "mixed", "varied"],
    "discount": ["reduction", "markdown", "reduced price"],
    "undergraduate": ["college student", "university student"],
    "major in": ["specialize in", "study"],
    "specially trained": ["professionally trained", "qualified"],
    "contract": ["agreement", "deal"],
    "technician": ["specialist", "mechanic"],
    "manufacturer": ["maker", "producer"],
    "raw materials": ["basic materials", "inputs"],
    "distributor": ["supplier", "wholesaler"],
    "consumer": ["customer", "buyer"],
    "memo": ["notice", "memorandum"],
    "break room": ["staff lounge", "employee lounge"],
    "customer": ["client", "buyer", "patron"],
    "client": ["customer", "account", "patron"],
    "misunderstanding": ["confusion", "mix-up"],
    "make it up to": ["compensate", "repay", "make amends"],
    "rental contract": ["lease", "rental agreement"],
    "audition": ["tryout", "screen test"],
    "candidate": ["applicant", "contender"],
    "cycling trail": ["bike path", "bicycle trail"],
    "fund": ["finance", "sponsor", "support"],
    "proposal": ["plan", "suggestion", "recommendation"],
    "persuasive": ["convincing", "compelling"],
    "reimbursement": ["refund", "repayment"],
    "business trip": ["work trip", "business travel"],
    "guidebook": ["manual", "handbook"],
    "vendor": ["supplier", "seller"],
    "messenger service": ["courier service", "delivery service"],
    "urgent": ["pressing", "immediate", "time-sensitive"],
    "prioritize": ["give priority to", "rank first"],
    "visitor": ["guest", "attendee"],
    "presence": ["attendance", "being there"],
    "specialist": ["expert", "professional"],
    "screening": ["evaluation", "review", "showing"],
    "application": ["form", "request", "submission"],
    "reduced prices": ["discounts", "lower prices", "markdowns"],
    "guidelines": ["instructions", "rules", "directions"],
    "absence": ["nonattendance", "being away"],
    "firmly sealed": ["tightly closed", "securely closed"],
    "vital": ["essential", "crucial", "important"],
    "assess": ["evaluate", "appraise", "judge"],
    "relocation": ["move", "transfer"],
    "promptly": ["immediately", "quickly", "without delay"],
    "inspection": ["examination", "review", "check"],
    "agreement": ["contract", "arrangement"],
    "commuter": ["daily traveler", "regular passenger"],
    "floor space": ["floor area", "usable space"],
    "compatible": ["suitable", "consistent", "matching"],
    "package": ["parcel", "pack", "wrap"],
    "come across": ["encounter", "find", "discover"],
    "anonymity": ["privacy", "namelessness"],
    "forum": ["discussion board", "meeting"],
    "shorthand": ["abbreviation", "short form"],
    "pantry": ["kitchenette", "storage room"],
    "current affairs": ["news", "topical issues"],
    "interviewee": ["respondent", "applicant"],
    "backyard barbecue": ["outdoor cookout", "barbecue"],
    "pool party": ["poolside event", "swimming party"],
    "model home": ["show home", "sample house"],
    "stain removal": ["cleaning", "spot treatment"],
    "complimentary": ["free", "no-cost", "included"],
    "internship program": ["training program", "internship"],
    "alumni": ["graduates", "former students"],
    "workshop": ["seminar", "training session"],
    "participant": ["attendee", "member"],
    "be described as": ["be referred to as", "be characterized as", "be called"],
    ...
    "approach (to)": ["method", "strategy", "way"],
    "numerous": ["many", "multiple", "a number of"],
    "recall": ["withdraw", "take back"],
    "bid": ["proposal", "offer", "tender"],
    "costly": ["expensive", "high-priced"],
    "accompany": ["go with", "come with"],
    "emphasis (on)": ["focus", "stress", "importance"],
    "vacate": ["leave", "evacuate"],
    "demand (for)": ["need", "request", "market need"],
    "power outage": ["blackout", "power failure"],
    "fragile": ["delicate", "easily broken"],
    "courier": ["messenger", "delivery person"],
    "needlessly": ["unnecessarily", "without need"],
    "exceed": ["surpass", "go beyond"],
    "valid": ["effective", "legitimate"],
    "certification": ["credential", "qualification"],
    "take precautions": ["take safety measures", "be careful"],
    ...
    "procure": ["obtain", "acquire", "purchase"],
    "counterfeit": ["fake", "forged"],
    "operational": ["functioning", "working"],
    "appliance": ["device", "machine", "household equipment"],
}
...
def enrich_vocab_items(items):
    ...
    for raw in items:
        ...
        synonyms = synonym_suggestions(item)
